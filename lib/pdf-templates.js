...
const labelStyles = `
  *{box-sizing:border-box;-webkit-print-color-adjust:exact;print-color-adjust:exact;margin:0;padding:0}
  ...
  .lbl-symbols{margin-top:auto;border-top:2.5px solid #000;padding-top:3.5mm;display:flex;justify-content:space-evenly;align-items:flex-end}
  .lbl-symbols svg{width:14mm;height:14mm;display:block}
  .lbl-symbols .sym{text-align:center}
  .lbl-symbols .sym span{display:block;font-size:6.5pt;font-weight:800;letter-spacing:0.5px;text-transform:uppercase;margin-top:1.2mm}
`;

// Símbolos estándar de manipulación de cajas (trazos negros, sin marca).
const HANDLING_SYMBOLS = `<div class="lbl-symbols">
  <div class="sym"><svg viewBox="0 0 40 40" fill="none" stroke="#000" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M13 30V13"/><path d="M13 13l-5.5 6.5"/><path d="M13 13l5.5 6.5"/><path d="M27 30V13"/><path d="M27 13l-5.5 6.5"/><path d="M27 13l5.5 6.5"/><path d="M7 35h26"/></svg><span>Este lado arriba</span></div>
  <div class="sym"><svg viewBox="0 0 40 40" fill="none" stroke="#000" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M13 5h14"/><path d="M13 5l1.5 9a5.5 5.5 0 0 0 11 0L27 5"/><path d="M20 20v10"/><path d="M14 34h12"/></svg><span>Frágil</span></div>
  <div class="sym"><svg viewBox="0 0 40 40" fill="none" stroke="#000" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M7 21a13 13 0 0 1 26 0z"/><path d="M20 21v9a3 3 0 0 0 6 0"/><path d="M10 29l-1.5 4"/><path d="M31 29l1.5 4"/></svg><span>Mantener seco</span></div>
</div>`;
...
export function printPackageLabels({ op, packages = [], items = [], client, baseUrl = "https://www.argencargo.com.ar" }) {
  ...
  const labels = packages.flatMap((pk) => {
    ...
    return Array.from({ length: q }, () => { bultoN += 1; return `<div class="label${discreto ? " disc" : ""}">
      ...
      ${discreto ? HANDLING_SYMBOLS : `<div class="lbl-bottom">
