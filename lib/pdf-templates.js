...
const labelStyles = `
  *{box-sizing:border-box;-webkit-print-color-adjust:exact;print-color-adjust:exact;margin:0;padding:0}
  ...
  .lbl-logo{display:flex;justify-content:center;border-bottom:2.5px solid #000;padding-bottom:3mm;margin-bottom:3mm}
  .lbl-logo img{height:28mm;max-width:92mm;object-fit:contain}
  .lbl-code{font-family:'SF Mono','Courier New',monospace;font-size:23pt;font-weight:800;color:#000;letter-spacing:1px;text-align:center;margin-bottom:1mm}
  .lbl-cli{font-size:11pt;color:#000;margin-bottom:3mm;font-weight:700;text-align:center}
  .lbl-bulto-num{display:block;padding:2mm 4mm;color:#000;font-size:12pt;font-weight:800;letter-spacing:1px;margin-bottom:3mm;text-align:center;border-top:1.5px solid #000;border-bottom:1.5px solid #000}
  .lbl-peso-box{background:#fff;border:2px solid #000;border-radius:4px;padding:3mm;text-align:center;margin-bottom:2.5mm}
  .lbl-peso-label{font-size:8pt;color:#000;text-transform:uppercase;letter-spacing:1.2px;margin-bottom:1mm;font-weight:800}
  .lbl-peso-val{font-size:26pt;font-weight:800;color:#000;letter-spacing:-0.5px;line-height:1}
  .lbl-peso-fact{font-size:10.5pt;color:#000;margin-top:1.5mm;font-weight:800}
  .lbl-peso-detail{font-size:8.5pt;color:#000;margin-top:1mm;font-weight:600}
  .lbl-totales{display:flex;gap:3mm;margin-bottom:3mm;padding:2.5mm;background:#fff;border-radius:4px;border:1.5px solid #000}
  .lbl-totales > div{flex:1;text-align:center}
  .lbl-totales .tot-label{font-size:8pt;color:#000;text-transform:uppercase;letter-spacing:0.5px;font-weight:800;margin-bottom:1mm;display:block}
  .lbl-totales .tot-val{font-size:13pt;font-weight:800;color:#000;display:block}
  .lbl-bottom{margin-top:auto;border-top:2px solid #000;padding-top:3mm;text-align:center}
  .lbl-qr{width:32mm;height:32mm;display:block;margin:0 auto;image-rendering:pixelated}
  .lbl-barcode-text{font-family:'SF Mono','Courier New',monospace;font-size:13pt;color:#000;letter-spacing:3px;margin-top:1.5mm;font-weight:800}
  .lbl-qr-hint{font-size:7.5pt;color:#000;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;margin-top:1mm}
`;
