...
const labelStyles = `
  *{box-sizing:border-box;-webkit-print-color-adjust:exact;print-color-adjust:exact;margin:0;padding:0}
  ...
  .lbl-info{flex:1;display:flex;flex-direction:column;justify-content:center;text-align:center;padding:4mm 4mm}
  .lbl-info .lbl-peso-label{margin-bottom:1.5mm}
  .lbl-info-val{font-size:20pt;font-weight:800;line-height:1.1;min-width:0}
  .lbl-info-sep{width:30mm;height:1.5px;background:#000;margin:4mm auto}
  .lbl-info-val.desc{font-size:12pt;line-height:1.25;overflow-wrap:anywhere;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}
...
function packageLabelsHtml({ op, packages = [], client, entrega = null, baseUrl = "https://www.argencargo.com.ar" }) {
  ...
  const rutaBox = `<div class="lbl-peso-box lbl-info">
    <div class="lbl-peso-label">Origen</div>
    <div class="lbl-info-val">${escL(ruta.origen)}</div>
    <div class="lbl-info-sep"></div>
    <div class="lbl-peso-label">Mercadería</div>
    <div class="lbl-info-val desc">${escL(String(ruta.mercaderia || "—").slice(0, 70))}</div>
  </div>`;
