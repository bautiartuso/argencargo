...
const labelStyles = `
  *{box-sizing:border-box;-webkit-print-color-adjust:exact;print-color-adjust:exact;margin:0;padding:0}
  ...
  .lbl-logo img{height:30mm;max-width:92mm;object-fit:contain;filter:grayscale(1) brightness(0)}
  ...
  .lbl-barcode{height:26mm;width:auto;max-width:94mm;display:block;margin:0 auto;image-rendering:pixelated}
  .lbl-barcode-text{font-family:'SF Mono','Courier New',monospace;font-size:13pt;color:#000;letter-spacing:3px;margin-top:1mm;font-weight:800}
`;
