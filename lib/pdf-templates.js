...
export function printAereoAQuotePdf({ clientName = "", origin = "China", channelName = "Aéreo Courier Comercial", fleteAmt = 0, products = [], flete = 0, battExtra = 0, surcharge = 0, seguro = 0, derechos = 0, tasaE = 0, iva = 0, desembolso = 0, ivaDesembolso = 0, totalFob = 0, totalImport = 0 }) {
