...
const labelStyles = `
  *{box-sizing:border-box;-webkit-print-color-adjust:exact;print-color-adjust:exact;margin:0;padding:0}
  ...
  .lbl-barcode{height:20mm;width:100%;max-width:90mm;object-fit:contain;display:block;margin:0 auto}
  .lbl-barcode-text{font-family:'SF Mono','Courier New',monospace;font-size:9pt;color:#000;letter-spacing:2px;margin-top:1mm;font-weight:700}
  ...
  const labels = packages.map((pk, idx) => {
    ...
    return `<div class="label">
      ...
      <div class="lbl-bottom">
        <div class="lbl-barcode-label">Control interno</div>
        <img class="lbl-barcode" src="${barcodeUrl(barcodeData, 70)}" alt="Código de barras"/>
