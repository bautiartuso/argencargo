...
<style>
  *{box-sizing:border-box;margin:0;padding:0;-webkit-print-color-adjust:exact;print-color-adjust:exact}
  @page{size:A4;margin:0}
  html,body{background:#fff;color:#000;font-family:Arial,Helvetica,sans-serif;font-size:8.5pt;line-height:1.32}
  body{padding:8mm 8mm}
  .doc{max-width:194mm;margin:0 auto;background:#fff}
  /* ── Header ── */
  ...
  /* ── Receptor block ── */
  .receptor{border:1px solid #000;border-top:none;display:grid;grid-template-columns:1.4fr 1fr;padding:0}
  .receptor-l,.receptor-r{padding:2.5mm 3mm;font-size:8.5pt}
  .receptor-r{border-left:1px solid #000;text-align:right}
  ...
  .totals-bottom{display:grid;grid-template-columns:1fr auto;gap:6mm;padding:3mm 3mm 2mm;border:1px solid #000;border-top:none;font-size:9pt}
  .totals-bottom .recibi{align-self:flex-end;font-size:8.5pt}
  .totals-bottom .t-list{text-align:right;line-height:1.7}
  .totals-bottom .t-list b{font-weight:700}
  .totals-bottom .t-list .big{font-size:11pt;font-weight:700}
  /* ── Footer barcode + QR + legal ── */
  .footer-row{display:grid;grid-template-columns:1fr auto;align-items:end;gap:6mm;padding:3mm 3mm 2mm;border:1px solid #000;border-top:none}
  .footer-bc img{height:14mm;width:100%;max-width:90mm;display:block}
  .footer-bc-num{font-size:8pt;letter-spacing:1px;text-align:center;margin-top:0.5mm;font-family:monospace}
  .footer-qr img{width:24mm;height:24mm;display:block}
  .legal-block{padding:2mm 3mm;border:1px solid #000;border-top:none;font-size:7pt;line-height:1.4;color:#222}
  .legal-block b{font-weight:700}
  .ftr-info{padding:1.5mm 3mm;display:flex;justify-content:space-between;border:1px solid #000;border-top:none;font-size:7.5pt}
  .ftr-info b{font-weight:700}
  .legal-warn{padding:1.5mm 3mm;font-size:7pt;font-style:italic;border:1px solid #000;border-top:none}
</style></head><body>
<div class="doc">
  <!-- HEADER -->
  <div class="hdr">
  ...
  <div class="receptor">
    ...
    <div class="receptor-r">
      <p style="font-weight:700">CONTADO</p>
  ...
  <table class="liq">
    ...
    <tbody>
      ...
      <tr><td class="cat">IVA</td><td>0,00</td><td>0,00</td><td>0,00</td><td>0,00</td></tr>
      <tr><td class="cat">Percep. IIBB</td><td></td><td></td><td></td><td>0,00</td></tr>
      <tr class="va-line"><td class="cat">Valor en Aduana</td><td></td><td></td><td></td><td>${fmt(-subtotalA)} (A s/Iva)</td></tr>
      <tr><td class="cat" colspan="5"><div class="va-detail">Comprobante emitido por Responsable Monotributo — sin discriminación de IVA</div></td></tr>
    </tbody>
  </table>
  ...
  <!-- LEGAL -->
  <div class="legal-warn">**Por reclamos, comunicarse al 08101223345 **No se aceptan reclamos transcurridos 30 días fecha de factura.**Las facturas no abonadas en termino pueden ocasionar el cierre de la cuenta.</div>
  <div class="legal-block">
    El servicio de correo internacional se encuentra exento de I.V.A. (apartado 13, inc. H art. 70 Ley 23.349). El servicio de correo domestico, logistica, courier in-house, global mail domestico, honorarios por desaduanaje, gastos administrativos y seguros se encuentran gravados con I.V.A. a la alicuota del 21%. Las facturas que fueran emitidas bajo modalidad "contado" cumplen la funcion de factura y recibo simultaneamente. A todos los efectos legales, se establece el domicilio de Avenida Larrazabal 2255 - Ciudad Autonoma de Buenos Aires - como lugar de cumplimiento de la presente obligacion.
  </div>
  <div class="ftr-info">
