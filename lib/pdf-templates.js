...
export function printReceiptPdf({ op, payment, client, settings = {}, saldoRestante = null }) {
  ...
  const html = `<style>
    ...
    .rc{font-family:Inter,Helvetica,Arial,sans-serif;color:#111;width:190mm;min-height:118mm;box-sizing:border-box;padding:8mm 9mm;border:1.5px solid #111;border-radius:6px;position:relative;display:flex;flex-direction:column;gap:5px}
    ...
    .rc-foot{position:absolute;left:9mm;right:9mm;bottom:4mm;display:flex;justify-content:space-between;font-size:8px;color:#9ca3af}
  ...
  <div class="rc">
    <div class="rc-head">
      ...
      <div class="nro">N.º <b>${nro}</b><img src="${LOGO}" alt="Argencargo"/></div>
    </div>
    ...
    <div class="rc-foot"><span>Documento no válido como factura. Acredita únicamente la recepción del importe indicado.</span><span>argencargo.com.ar · Virrey Loreto 2428, Belgrano, CABA</span></div>
  </div>`;
