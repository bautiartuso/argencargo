...
function barcodeUrl(text, height = 80) {
  ...
  return `https://barcode.tec-it.com/barcode.ashx?data=${encodeURIComponent(text)}&code=Code128&dpi=300&imagetype=Png&translate-esc=on&height=${height}&modulewidth=1.2`;
}
