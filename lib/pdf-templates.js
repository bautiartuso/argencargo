...
export function printReceiptPdf({ op, payment, client, settings = {}, saldoRestante = null }) {
  ...
  const html = `<style>
    ...
    .rc{font-family:Inter,Helvetica,Arial,sans-serif;color:#111;width:192mm;height:112mm;overflow:hidden;box-sizing:border-box;padding:8mm 9mm;border:1.5px solid #111;border-radius:6px;position:relative;display:flex;flex-direction:column;gap:5px}
    .rc-head{display:flex;justify-content:space-between;align-items:flex-end;margin-bottom:4px}
    ...
    .rc-head .right{display:flex;flex-direction:column;align-items:flex-end;gap:6px}
    .rc-head .right img{height:14mm;width:auto}
    ...
    .rc-box{background:#e5e7eb;border-radius:8px;padding:8px 14px;font-size:13px;font-weight:700;font-style:italic;color:#111;min-height:22px}
    ...
    .rc-after{width:192mm;height:20mm;display:flex;justify-content:space-between;align-items:center;gap:24px;padding:0 3mm}
    ...
    body{padding:7mm 9mm 0!important;margin:0!important;background:#fff}
    @media print{body{margin:0}}
  </style>
  <div class="rc">
    <div class="rc-head">
      <div><h1>RECIBO</h1><div class="rc-lbl">Argencargo · ${op.operation_code}${client?.client_code ? ` · ${client.client_code}` : ""}</div></div>
      <div class="right"><img src="${LOGO_HORIZONTAL}" alt="Argencargo"/><div class="nro">N.º <b>${nro}</b></div></div>
    </div>
