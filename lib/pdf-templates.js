...
export function printReceiptPdf({ op, payment, client, settings = {}, saldoRestante = null }) {
  ...
  const html = `<style>
    ...
    .rc-box{background:#e5e7eb;border-radius:8px;padding:0 14px;height:30px;display:flex;align-items:center;font-size:13px;font-weight:700;font-style:italic;color:#111;line-height:1;margin:2px 0 4px}
