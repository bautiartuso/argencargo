...
const labelStyles = `
  *{box-sizing:border-box;-webkit-print-color-adjust:exact;print-color-adjust:exact;margin:0;padding:0}
  ...
  .label.disc{border:3px solid #000;border-radius:5mm;height:146mm;margin:2mm;padding:4mm 5mm 3mm}
  .lbl-mascot{margin-top:auto;display:flex;justify-content:center;align-items:flex-end;padding-top:1mm}
  .lbl-mascot img{width:52mm;height:auto;display:block}
`;
