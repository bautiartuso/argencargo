    ...
    ideas: {
      ...
      items: {
        ...
        properties: {
          ...
          slides: { type: "integer", description: "Cantidad de imágenes. feed: siempre 1. carousel: 3 a 6. story: 1 si es una idea liviana; 2 a 4 si es una nota que hay que desarrollar (secuencia)." },
...
const CHAT_SCHEMA = {
  ...
  properties: {
    ...
    slides: { type: "integer", description: "feed: 1. carousel: 3 a 6. story: 1 suelta, 2 a 4 secuencia." },
