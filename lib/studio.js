...
export async function processPiece(piece) {
  ...
  try {
    ...
    const draft = { ...piece, html };
    const image_url = await renderPiece(draft);
    await patch({ status: "review", headline: d.headline, subheadline: d.subheadline, caption: d.caption, hashtags: d.hashtags, html, image_url, photo_url: photoUrl, error: null, locked_at: null, feedback: null });
