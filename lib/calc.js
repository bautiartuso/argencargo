...
export function calcOpBudget(op, items, pkgs, tariffs, config, clientOverrides, client) {
  ...
  return { totalTax, flete, fleteCost, fleteRate, fleteCostRate, fleteAmt, seguro, totalAbonar, realCost, shipCost, surcharge, surchargePct, vpu, surchargeUnit, surchargeNextThreshold, surchargeNextRate };
}
