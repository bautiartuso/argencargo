...
export function calcOpBudget(op, items, pkgs, tariffs, config, clientOverrides, client, declaredItems = []) {
  ...
  return { totalTax, taxesBilledByArgencargo, flete, battExtra, overweightSurcharge, overweightPieces, fleteCost, fleteRate, fleteCostRate, fleteAmt, seguro, totalAbonar, realCost, shipCost, surcharge, surchargePct, vpu, surchargeUnit, surchargeNextThreshold, surchargeNextRate, despachoReal };
}
