"use client";
// Piezas visuales de Argenmaq. Los colores son variables CSS para que el tema claro/oscuro
// (Ajustes) cambie todo de una. Amarillo de maquinaria como acento, grises acero de neutro.
...
export const LIMA="var(--mq-lima)", LIMA_SUAVE="var(--mq-lima-suave)";   // "lima" por historia: hoy es el amarillo
...
.mq{--mq-bg:#FFFFFF;--mq-card:#FFFFFF;--mq-ink:#15171A;--mq-gris:#6B7075;--mq-borde:#E3E5E8;--mq-suave:#F4F5F7;--mq-lima:#FFD200;--mq-lima-suave:#FFF3B0;--mq-lima-ink:#15171A;--mq-ok:#1F7A2E;--mq-ok-bg:#E3F6E6;--mq-warn:#8A5B00;--mq-warn-bg:#FFF1CC;--mq-bad:#B42323;--mq-bad-bg:#FDECEC}
.mq[data-tema="oscuro"]{--mq-bg:#0F1012;--mq-card:#17191C;--mq-ink:#F2F3F4;--mq-gris:#9AA0A6;--mq-borde:#2A2D31;--mq-suave:#1E2125;--mq-lima:#FFD200;--mq-lima-suave:#3B3306;--mq-ok:#7BD88F;--mq-ok-bg:#16301B;--mq-warn:#E9C46A;--mq-warn-bg:#3A2E0E;--mq-bad:#F28B8B;--mq-bad-bg:#3A1616}
...
// Cifra suelta: sin borde, con una raya de acento. Distinto a las cards del admin de Argencargo.
...
// Barras simples: series [{l, a, b?}] con a (ingresos) y b (egresos) opcionales.
