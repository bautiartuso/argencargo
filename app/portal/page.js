...
function PointsPage({token,client}){
  ...
  return <div>
    <div style={{background:"rgba(255,255,255,0.04)",borderRadius:12,border:"1px solid rgba(255,255,255,0.06)",padding:"16px 20px",marginBottom:20,display:"flex",justifyContent:"space-between",alignItems:"center",gap:12,flexWrap:"wrap"}}>
      <div><h2 style={{fontSize:26,fontWeight:700,color:"#fff",margin:0,letterSpacing:"-0.02em"}}>Mis puntos</h2><p style={{fontSize:13,color:"rgba(255,255,255,0.4)",margin:"2px 0 0"}}>Ganás puntos por cada kg aéreo y CBM marítimo que importes con nosotros.</p></div>
    </div>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:12,marginBottom:20}}>
      ...
      <div style={{background:"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.06)",borderRadius:14,padding:"20px 22px"}}>
    ...
    {pending.length>0&&<div style={{marginBottom:24}}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:8}}>{pending.map(p=><div key={p.id} style={{background:"rgba(184,149,106,0.06)",border:"1px solid rgba(184,149,106,0.2)",borderRadius:10,padding:"12px 16px",display:"flex",justifyContent:"space-between",alignItems:"center",gap:12,flexWrap:"wrap"}}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(260px,1fr))",gap:12,marginBottom:24}}>{catalog.map(r=>{
      ...
      return <div key={r.id} style={{background:"rgba(255,255,255,0.04)",border:`1.5px solid ${canRedeem?"rgba(184,149,106,0.25)":"rgba(255,255,255,0.06)"}`,borderRadius:14,padding:"18px 20px",display:"flex",flexDirection:"column",gap:10,opacity:canRedeem?1:0.55}}>
