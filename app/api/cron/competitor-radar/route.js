// GET /api/cron/competitor-radar — RADAR DE COMPETENCIA: todos los días baja los últimos posts de las
...
export async function GET(req) {
  ...
  return Response.json({ ok: true, ...(await radarCompetencia({ analizar: 15 })) });
}
