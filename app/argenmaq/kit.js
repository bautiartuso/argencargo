...
.amq .orden .pagoBox{border-left:3px solid var(--y);background:var(--suave);border-radius:12px;padding:14px 16px;margin:14px 0 16px}
.amq .orden .fila{display:flex;justify-content:space-between;align-items:center;gap:12px}
.amq .orden .fila+.fila{margin-top:10px;padding-top:10px;border-top:1px solid var(--borde)}
...
.amq[data-tema="oscuro"] .orden .pagoBox{background:var(--suave)}
...
.amq .chkPagina{display:grid;grid-template-columns:minmax(0,1fr) 440px;min-height:100vh}
.amq .chkIzq{padding:22px 40px 60px 40px;max-width:900px;justify-self:end;width:100%}
.amq .chkDer{background:var(--suave);padding:22px 32px 60px;border-left:1px solid var(--borde)}
.amq .chkNav{display:flex;align-items:center;gap:22px;margin-bottom:26px}
@media(max-width:980px){.amq .chkPagina{grid-template-columns:1fr}.amq .chkIzq{padding:18px 20px 30px;justify-self:stretch}.amq .chkDer{border-left:none;border-top:1px solid var(--borde);padding:22px 20px 40px}}
.amq .chkNav .lk{font-size:13.5px;font-weight:600;color:var(--gris);display:inline-flex;align-items:center;gap:6px}
.amq .chkNav .lk:hover{color:var(--ink)}
.amq .dosBarra{height:8px;border-radius:999px;background:var(--borde);overflow:hidden;margin:10px 0 12px}
.amq .dosBarra i{display:block;height:100%;background:var(--y);border-radius:999px}
.amq .cajaSec{border:1px solid var(--borde);border-radius:22px;background:var(--card);padding:20px 22px}
.amq .cajaSec h3{margin:0 0 14px;font-size:17px;font-weight:800;letter-spacing:-0.01em}
.amq .pagoOpc{display:grid;grid-template-columns:1fr 1fr;gap:10px}
.amq .pagoOpc button{text-align:left;padding:16px 18px;border-radius:18px;border:1.5px solid var(--borde);background:transparent;color:var(--ink);cursor:pointer;font-family:inherit}
.amq .pagoOpc button.on{border-color:var(--y);background:var(--ysuave)}
.amq .pagoOpc b{display:flex;align-items:center;gap:8px;font-size:15.5px}
.amq .pagoOpc small{display:block;margin-top:4px;font-size:12.5px;color:var(--gris);line-height:1.4}
.amq .acord{border:1px solid var(--borde);border-radius:16px;padding:0 16px;background:var(--card)}
.amq .acord>button{width:100%;display:flex;align-items:center;gap:10px;padding:15px 0;border:none;background:transparent;color:var(--ink);font-weight:700;font-size:14.5px;cursor:pointer;font-family:inherit;text-align:left}
.amq .monedaChips{display:inline-flex;gap:6px;padding:4px;border-radius:999px;background:var(--suave)}
.amq .monedaChips button{padding:7px 14px;border-radius:999px;border:none;background:transparent;color:var(--gris);font-weight:800;font-size:12.5px;cursor:pointer;font-family:inherit}
.amq .monedaChips button.on{background:var(--card);color:var(--ink);box-shadow:0 2px 8px rgba(0,0,0,0.08)}
@media(max-width:640px){.amq .pagoOpc{grid-template-columns:1fr}}
.amq .perfilGrid{display:grid;grid-template-columns:300px minmax(0,1fr);gap:26px;align-items:start}
.amq .perfilNav a{display:flex;align-items:center;gap:14px;padding:12px 16px;border:1px solid var(--borde);border-radius:999px;background:var(--card);font-weight:700;font-size:15px;margin-bottom:10px}
.amq .perfilNav a .cir{width:44px;height:44px;border-radius:50%;background:var(--suave);display:inline-flex;align-items:center;justify-content:center;flex-shrink:0}
.amq .perfilNav a.on{background:var(--ysuave);border-color:var(--y)}.amq .perfilNav a.on .cir{background:var(--y);color:#15171A}
.amq .perfilCard{border:1px solid var(--borde);border-radius:24px;background:var(--card);padding:26px 28px;min-height:440px;display:flex;flex-direction:column}
.amq .vacio{text-align:center;padding:50px 20px;flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center}
.amq .vacio .cir{width:74px;height:74px;border-radius:50%;background:var(--ysuave);border:1px solid var(--y);display:inline-flex;align-items:center;justify-content:center;margin-bottom:18px}
.amq .menuPerfil{position:absolute;right:0;top:calc(100% + 10px);width:250px;background:var(--card);border:1px solid var(--borde);border-radius:18px;box-shadow:var(--sombra);padding:8px;z-index:45}
.amq .menuPerfil a,.amq .menuPerfil button{display:flex;align-items:center;gap:12px;width:100%;padding:12px 14px;border-radius:12px;border:none;background:transparent;color:var(--ink);font-weight:600;font-size:15px;cursor:pointer;font-family:inherit;text-align:left}
.amq .menuPerfil a:hover,.amq .menuPerfil button:hover{background:var(--suave)}
.amq .menuPerfil hr{border:none;border-top:1px solid var(--borde);margin:6px 4px}
.amq .notifCard{border:1px solid var(--borde);border-radius:20px;padding:20px}
.amq .notifFila{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:14px 16px;border-radius:14px;background:var(--ysuave);border:1px solid var(--y);margin-top:10px;font-weight:600;font-size:14.5px}
.amq .sw{width:46px;height:26px;border-radius:999px;background:var(--borde);position:relative;border:none;cursor:pointer;flex-shrink:0;padding:0}
.amq .sw.on{background:var(--ink)}.amq .sw i{position:absolute;top:3px;left:3px;width:20px;height:20px;border-radius:50%;background:#fff;transition:left 120ms}.amq .sw.on i{left:23px}
.amq .btn.borde{background:transparent;border:1.5px solid var(--ink)}
@media(max-width:900px){.amq .perfilGrid{grid-template-columns:1fr}.amq .perfilCard{padding:20px 18px}}
...
function PanelOrden({ onCerrar }) {
  ...
  return <><div className="velo" onClick={onCerrar} /><aside className="orden" role="dialog" aria-label={t("tuOrden")}>
    ...
    {carrito.length > 0 && <div className="pie">
      <div className="fila"><span style={{ fontWeight: 800, fontSize: 17 }}>{t("totalPedido")}</span><b style={{ fontSize: 20, letterSpacing: "-0.02em" }}>{ses ? fmt(total) : "—"}</b></div>
      {ses && <div className="pagoBox">
        <div className="fila"><span style={{ display: "inline-flex", alignItems: "center", gap: 10, fontWeight: 800, fontSize: 15 }}><span className="cirI"><Ico d={["M3 7h18v12H3z", "M3 11h18", "M7 15h3"]} size={14} /></span>{t("ahoraAlConfirmar")}</span><b style={{ fontSize: 17 }}>{fmt(anticipo)}</b></div>
        <div className="fila"><span style={{ display: "inline-flex", alignItems: "center", gap: 10, color: "var(--gris)", fontSize: 14 }}><span className="cirI" style={{ background: "var(--borde)", color: "var(--ink)" }}><Ico d={["M3 5h18v16H3z", "M3 10h18", "M8 3v4", "M16 3v4"]} size={14} /></span><span>{t("alLlegar")}<br /><small style={{ fontSize: 12 }}>{llega}</small></span></span><b style={{ fontSize: 17 }}>{fmt(saldo)}</b></div>
      </div>}
...
export function Marco({ actual, children, conGrupo, franja, checkout }) {
  const { tema, setTema, lang, setLang, t, moneda, setMoneda, tc, ses, cliente, carrito, salir } = useAM();
  ...
  // La isla con el buscador va en todo el sitio salvo la landing, Cómo funciona y Quiénes somos (22/09/2026).
  const enTienda = !["inicio", "como", "quienes"].includes(actual);
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          ...
          {ses && <div style={{ position: "relative" }}>
            ...
            {menu && <><div onClick={() => setMenu(false)} style={{ position: "fixed", inset: 0, zIndex: 44 }} /><div className="menuPerfil" role="menu">
              ...
              <a href="/cuenta?s=favoritos"><Ico d={["M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.7l-1-1.1a5.5 5.5 0 0 0-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 0 0 0-7.8z"]} size={18} />{t("favoritos")}</a>
              <hr />
              <button onClick={() => { setMenu(false); salir(); window.location.href = "/"; }}><Ico d={["M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4", "M16 17l5-5-5-5", "M21 12H9"]} size={18} />{t("cerrarSesion")}</button>
            </div></>}
          </div>}
        </div>
      </div>
