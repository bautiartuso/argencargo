...
.amq .chkNav{padding:20px 0 6px}
.amq .chkNav .wrap{display:flex;align-items:center;gap:22px}
...
export function Marco({ actual, children, conGrupo, franja, checkout }) {
  ...
  return <>
    ...
    {checkout && <header className="chkNav"><div className="wrap"><a href="/" style={{ display: "flex", alignItems: "center" }}><Logo /></a><span style={{ flex: 1 }} /><a className="lk" href="/catalogo"><Ico d={["M19 12H5", "M12 19l-7-7 7-7"]} size={15} />{t("volverTienda")}</a><span className="lk"><Ico d={["M12 17a2 2 0 1 0 0-4 2 2 0 0 0 0 4z", "M5 10V8a7 7 0 0 1 14 0v2", "M4 10h16v11H4z"]} size={15} />{t("compraSegura")}</span></div></header>}
